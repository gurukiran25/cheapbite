...
export const PLATFORMS: Platform[] = [
  ...
  { id: "dominos", name: "Domino's", color: "#0078AE", rating: 4.4, searchUrl: "https://www.google.com/search?q=order+{q}+dominos+india" },
  { id: "mcd", name: "McDonald's", color: "#FFC72C", rating: 4.0, searchUrl: "https://www.google.com/search?q=order+{q}+mcdelivery+india" },
  { id: "kfc", name: "KFC", color: "#E4002B", rating: 4.2, searchUrl: "https://www.google.com/search?q=order+{q}+kfc+india" },
  { id: "pizzahut", name: "Pizza Hut", color: "#EE3124", rating: 4.1, searchUrl: "https://www.google.com/search?q=order+{q}+pizza+hut+india" },
  { id: "subway", name: "Subway", color: "#008C15", rating: 4.0, searchUrl: "https://www.google.com/search?q=order+{q}+subway+india" },
  { id: "burgerking", name: "Burger King", color: "#D62300", rating: 4.1, searchUrl: "https://www.google.com/search?q=order+{q}+burger+king+india" },
  { id: "magicpin", name: "MagicPin", color: "#E91E63", rating: 4.2, searchUrl: "https://magicpin.in/search/?q={q}" },
  { id: "thrive", name: "Thrive", color: "#7C3AED", rating: 4.0, searchUrl: "https://www.google.com/search?q=order+{q}+thrivenow" },
  { id: "ondc", name: "ONDC", color: "#1F6FEB", rating: 4.0, searchUrl: "https://www.mystore.in/en/search?query={q}" },
  { id: "dunzo", name: "Dunzo", color: "#00D26A", rating: 4.1, searchUrl: "https://www.google.com/search?q=order+{q}+dunzo" },
  { id: "boxes", name: "Box8", color: "#F26522", rating: 4.0, searchUrl: "https://www.google.com/search?q=order+{q}+box8" },
  { id: "faasos", name: "Faasos", color: "#C8102E", rating: 4.1, searchUrl: "https://www.google.com/search?q=order+{q}+faasos" },
];
